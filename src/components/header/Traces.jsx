...
const Traces = () => {
  ...
  useEffect(() => {
    ...
    // =========================================================
    const COLOR = {
      traceBase:    '#a0c8ff',   // dormant trace line
      traceGlow:    '#b4e1ff',   // lit trace glow
      viaDot:       '#c8e1ff',   // dots at bend points

      pulseCore:    '#ffffff',   // bright center dot of moving pulse
      pulseInner:   '#f0faff',   // pulse gradient inner
      pulseMiddle:  '#78c8ff',   // pulse gradient mid
      pulseOuter:   '#2878ff',   // pulse gradient outer edge (fades to 0)

      bloomRing:    '#b4dcff',   // expanding ring on arrival
      bloomFlash:   '#ffffff',   // core flash on arrival
    };
    // =========================================================
